...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      para([run("סכום התביעה: ", { bold: true }), run("38,100 ₪.")], { after: 40 }),
      ...
      clause([{ t: "גמול שעות נוספות: ", bold: true }, "475 שעות מעבר לשמונה שעות ביום, לפי התלושים, × 30 ₪ × 137.5%, ממוצע התעריפים 125% ו-150%, = 19,594 ₪, בניכוי 8,545 ₪ ששולמו כשכר יסוד שעתי, ובסה\"כ ", { t: "11,049 ₪", bold: true }, ". התובע שומר על זכותו להגדיל רכיב זה עם גילוי רישומי הנוכחות."]),
      ...
      clause(["סך הכל על הנתבעת לשלם לתובע ", { t: "38,100 ₪", bold: true }, ", בצירוף הפרשי הצמדה וריבית כחוק ממועד סיום העבודה ועד התשלום בפועל. לחלופין, ובכפוף לשיקול דעת בית הדין הנכבד, בצירוף פיצויי הלנת שכר והלנת פיצויי פיטורים לפי חוק הגנת השכר."]),
      ...
      clause(["התובע שומר על זכותו לתקן את כתב התביעה ולהוסיף עליו, לרבות בגין דמי מחלה ושכר חודש 9/2024, עם קבלת מלוא המסמכים מהנתבעת, ואין באמור לעיל כדי לגרוע מכל זכות העומדת לו על פי כל דין, הסכם, נוהג או צו הרחבה."]),
