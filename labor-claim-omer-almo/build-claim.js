...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      para([run("סכום התביעה: ", { bold: true }), run("52,226 ₪ (לצורכי אגרה: 50,000 ₪).")], { after: 40 }),
      ...
      clause([{ t: "סיכום. ", bold: true }, "על הנתבעת לשלם לתובע את הסך ", { t: "52,226 ₪", bold: true }, " בצירוף פיצויי הלנת שכר ופיצויי הלנת פיצויי פיטורים. לחלופין, בצירוף הפרשי הצמדה וריבית מקסימלית כחוק. לצורכי אגרה בלבד, ולאור מצבו הכלכלי של התובע, התביעה מוגשת אך על הסך של ", { t: "50,000 ₪", bold: true }, ", כאשר התובע שומר לעצמו את הזכות לשלם הפרשי אגרה ולהעמיד את התביעה על סכומה המקורי הנ\"ל."]),
